...
<br><br>
Desenvolvimento backend com Java, criação de APIs REST, estudo de frameworks como Spring Boot, boas práticas de programação, orientação a objetos, integração com bancos de dados e construção de projetos reais para evolução contínua.
